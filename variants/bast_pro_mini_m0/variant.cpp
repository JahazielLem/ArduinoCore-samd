...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  23, PIO_MULTI, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, TC4_CH1, No_ADC_Channel, EXTERNAL_INT_7, GCLK_CCL_NONE }, // 
  
  // 4 - PA22 -  GPIO 
  { PORTA,  22, PIO_MULTI, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, TC4_CH0, No_ADC_Channel, EXTERNAL_INT_6, GCLK_CCL_NONE }, //

  // 5 - PA15 - GPIO - PWM 
  { PORTA, 15, PIO_MULTI, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, TC3_CH1, No_ADC_Channel, EXTERNAL_INT_15, GCLK_CCL_NONE },
  ...
  // 8 - PA06 -  GPIO 
  { PORTA,  6, PIO_MULTI, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, TCC1_CH0, No_ADC_Channel, EXTERNAL_INT_6, GCLK_CCL_NONE }, // 
  
  // 9 - PA07 -  GPIO - PWM
  { PORTA,  7, PIO_MULTI, (PER_ATTR_DRIVE_STD|PER_ATTR_TIMER_STD), (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), TCC1_CH1, No_ADC_Channel, EXTERNAL_INT_7, GCLK_CCL_NONE }, // TCC0/WO[1]

  // SPI SERCOM3
  // 10 - PA18 -  GPIO - PWM - SS(SPI) 
  { PORTA,  18, PIO_SERCOM, (PER_ATTR_DRIVE_STD|PER_ATTR_TIMER_STD), (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER|PER_ATTR_SERCOM_ALT), TC3_CH0, No_ADC_Channel, EXTERNAL_INT_2, GCLK_CCL_NONE },  // TCC0/WO[0]
  ...
  { PORTA, 19, PIO_SERCOM, (PER_ATTR_DRIVE_STD|PER_ATTR_SERCOM_ALT), (PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), TC3_CH1, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE },
  ...
  // 20 - A2 - PA05 - GPIO 
  { PORTA,  5, PIO_MULTI, (PER_ATTR_DRIVE_STD|PER_ATTR_SERCOM_ALT), (PIN_ATTR_ADC|PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), TCC0_CH1, ADC_Channel5, EXTERNAL_INT_5, GCLK_CCL_NONE }, // ADC/AIN[0]

  // 21 - A3 - PA10 - GPIO
  { PORTA,  10, PIO_MULTI, PER_ATTR_DRIVE_STD, (PIN_ATTR_ADC|PIN_ATTR_DIGITAL), TCC1_CH0, ADC_Channel18, EXTERNAL_INT_10, GCLK_CCL_NONE }, // ADC/AIN[0]
